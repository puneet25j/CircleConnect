...
import { useCreateUserAccount, useSignInAccount } from '@/utilities/react-query/queries';
    ...
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">
          To use Circle-Connect, please enter your details
        </p>
        <form
        ...
        <p className="small-regular text-light-2 text-center mt-2">
          ...
          <Link to="/sign-in" className="text-primary-500 small-semibold ml-1">
            Log in
          </Link>
        </p>
      </div>
